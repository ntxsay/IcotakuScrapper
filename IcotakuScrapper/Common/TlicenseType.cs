...
/// <summary>
/// Représente le type de licence qu'a obtenu un distributeur d'animé ou Manga ou autre
/// </summary>
public class TlicenseType
{
    ...
    public TlicenseType(int id)
    {
        Id = id;
    }

    public TlicenseType(string name, string? description = null)
    {
        Name = name;
        Description = description;
    }

    public TlicenseType(int id, string name, string? description = null)
    {
        Id = id;
        Name = name;
        Description = description;
    ...
    /// <summary>
    /// Compte le nombre d'entrées dans la table TlicenseType ayant l'identifiant spécifié
    /// </summary>
    /// <param name="id"></param>
    /// <param name="cancellationToken"></param>
    /// <param name="cmd"></param>
    ...
    /// <summary>
    /// Compte le nombre d'entrées dans la table TlicenseType ayant le nom spécifié
    /// </summary>
        ...
        CancellationToken? cancellationToken = null, SqliteCommand? cmd = null)
    {
        ...
        if (!reader.HasRows)
            return Array.Empty<TlicenseType>();
    ...
    internal static TlicenseType GetRecord(SqliteDataReader reader, int idIndex, int sectionIndex, int nameIndex, int descriptionIndex)
    {
        return new TlicenseType()
        {
    ...
    private static async IAsyncEnumerable<TlicenseType> GetRecords(SqliteDataReader reader,
        CancellationToken? cancellationToken = null)
    {
